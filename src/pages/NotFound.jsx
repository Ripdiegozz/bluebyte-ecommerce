...
function NotFound() {
  return (
<Layout>
  <div className="w-full px-16 md:px-0 h-screen flex items-center justify-center gap-5 min-[320px]:max-md:flex-col">
      <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-lg">
